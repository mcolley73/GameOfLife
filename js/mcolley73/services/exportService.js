...
gameOfLifeApp.factory('exportService', ['$log', 'sampleWorldService', 'rleService', function($log, sampleWorldService, rleService){
  ...
  var exportService = {
    ...
    **/
    ...
    generateExportData: function(world, rules){
      ...
      }else if(this.exportFormat === 'rle'){
        this.exportData = this.asRleFile(world, rules);
      }else{
    ...
    asLif1_06_file: function(world, rules){
      ...
      lif1_06txt += "#D generated by CGOL at "+new Date() + "\n";
    ...
    asRleFile: function(world, rules){
      var rleStrings = rleService.fromGlyphArray(world);
      var rleText = rleStrings.join('\n');
      return rleText;
    },
